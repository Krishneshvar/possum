...
interface DisplayVariantsProps {
    product: any;
    getProductStatus: (status: string) => React.ReactNode;
    getVariantStockStatus: (variant: any) => { icon: React.ElementType, styles: string };
    formatPrice: (price: number) => string;
}

export default function DisplayVariants({ product, getProductStatus, getVariantStockStatus, formatPrice }: DisplayVariantsProps) {
  return (
    <CardContent>
