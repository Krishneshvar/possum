...
import { ISaleRepository, SaleFilter, PaginatedSales } from './sale.repository.interface.js';
import { generateInvoiceNumber, setSaleRepository } from './sale.utils.js';
...
let taxEngine: any;
let transaction: any;
let fetchVariantsBatch: any;
let fetchProductById: any;
let fetchCustomerById: any;
let validatePaymentMethod: any;
let getVariantStock: any;
let INVENTORY_REASONS: any;

export function initSaleService(
    ...
    saleRepository = repo;
    setSaleRepository(repo);
    inventoryService = inventorySvc;
    auditService = auditSvc;
    taxEngine = taxEng;
    transaction = txn;
    fetchVariantsBatch = deps.fetchVariantsBatch;
    fetchProductById = deps.fetchProductById;
    fetchCustomerById = deps.fetchCustomerById;
    validatePaymentMethod = deps.validatePaymentMethod;
    getVariantStock = deps.getVariantStock;
    INVENTORY_REASONS = deps.INVENTORY_REASONS;
}

export { SaleFilter, PaginatedSales };
