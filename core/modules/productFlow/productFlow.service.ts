 ...
 */
import { IProductFlowRepository, FlowQueryOptions } from './productFlow.repository.interface.js';

let productFlowRepository: IProductFlowRepository;
let buildImageUrl: any;

export function initProductFlowService(repo: IProductFlowRepository, imageUrlFn: any) {
  productFlowRepository = repo;
